...
{
    public static Task<TResponse> CallGetMethodAsync(string baseUrl, string? resource,
    ...
    public static Task<TResponse> CallPostMethodAsync(string baseUrl, string? resource,
